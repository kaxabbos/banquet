...
public class NotesCont extends Attributes {
    ...
    public String noteOrdering(@RequestParam Long masterId, @RequestParam String date, @RequestParam String time, @RequestParam int guests, @PathVariable Long noteId) {
        Masters master = mastersRepo.getReferenceById(masterId);
        Users client = getUser();
        Notes note = notesRepo.getReferenceById(noteId);

        Ordering ordering = new Ordering(master, client, note, date, time, guests);
    ...
    @PostMapping("/add")
    public String noteAddNew(Model model, @RequestParam String name, @RequestParam String address, @RequestParam Long categoryId, @RequestParam MultipartFile photo, @RequestParam int price, @RequestParam String description) {
        String res = "";
        ...
        Notes note = new Notes(name, res, price, description, address);
    ...
    @PostMapping("/edit/{id}")
    public String noteEditOld(Model model, @RequestParam String name, @RequestParam String address, @RequestParam Long categoryId, @RequestParam MultipartFile photo, @RequestParam int price, @RequestParam String description, @PathVariable Long id) {
